...
typedef enum _pq_case_func_e {
    PQ_CASE_FUNC_PICTURE_MODE = 0,
    PQ_CASE_FUNC_BACKLIGHT,
    PQ_CASE_FUNC_CONTRAST,
    PQ_CASE_FUNC_BRIGHTNESS,
    PQ_CASE_FUNC_SATURATION,
    PQ_CASE_FUNC_HUE,
    PQ_CASE_FUNC_SHARPNESS,
    PQ_CASE_FUNC_ASPECT_RATIO,
    PQ_CASE_FUNC_AI_PQ,
    PQ_CASE_FUNC_AI_COLOR,
    PQ_CASE_FUNC_AI_SR,
    PQ_CASE_FUNC_GAMMA,
    PQ_CASE_FUNC_MANUAL_GAMMA,
    PQ_CASE_FUNC_COLOR_TEMP,
    PQ_CASE_FUNC_COLOR_MANAGEMENT,
    PQ_CASE_FUNC_COLOR_CUSTOMIZE,
    PQ_CASE_FUNC_COLOR_RANGE_MODE,
    PQ_CASE_FUNC_COLOR_SPACE,
    PQ_CASE_FUNC_GLOBAL_DIMMING,
    PQ_CASE_FUNC_LOCAL_DIMMING,
    PQ_CASE_FUNC_BLACK_STRETCH,
    PQ_CASE_FUNC_DNLP,
    PQ_CASE_FUNC_LOCAL_CONTRAST,
    PQ_CASE_FUNC_SR,
    PQ_CASE_FUNC_DNR,
...
typedef enum output_type_e {
    ...
    OUTPUT_TYPE_HDMI_1080_2160 = 21,
    OUTPUT_TYPE_HDMI_720_2160,
    OUTPUT_TYPE_HDMI_576_2160,
    OUTPUT_TYPE_HDMI_480_2160,
    ...
    OUTPUT_TYPE_HDMI_1080_2160_HDR,
    OUTPUT_TYPE_HDMI_720_2160_HDR,
    OUTPUT_TYPE_HDMI_576_2160_HDR,
    OUTPUT_TYPE_HDMI_480_2160_HDR,
