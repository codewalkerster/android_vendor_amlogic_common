...
//color pri command list
#define AMVECM_IOC_COLOR_PRI_EN                _IO(AMVECM_IOC_MAGIC, 0x7d)
#define AMVECM_IOC_COLOR_PRIMARY               _IOW(AMVECM_IOC_MAGIC, 0x7e, struct color_primary_s)
//aicolor command list
#define AMVECM_IOC_AI_COLOR_EN                 _IO(AMVECM_IOC_MAGIC, 0x8b)
#define AMVECM_IOC_S_AI_COLOR_PARAM            _IOW(AMVECM_IOC_MAGIC, 0x8c, struct db_aicolor_param_s)
//sdr to hdr ioc
