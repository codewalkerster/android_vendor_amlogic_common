...
void SysFs::setProperty(const char *key, const char *value)
{
    int err;
...
bool SysFs::getProperty(const char *key, char *value)
{
...
bool SysFs::getPropertyBoolean(const char *key, bool def)
{
    int len;
    char buf[PROPERTY_VALUE_MAX] = {0};
    bool result = def;
