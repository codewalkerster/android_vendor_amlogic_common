...
#define SSM_MAX_PICTUREMODE_PARAM_SIZE                (84 + 4)

#define SSM_MAX_RGBOGO_PARAM_SIZE                     (30 + 4) //sizeof(tcon_rgb_ogo_t) + sizeof(int)
...
enum{
    ...
    VPP_DATA_POS_AISR_MODE_START = 310,
    VPP_DATA_POS_AIPQ_MODE_START = 311,
    VPP_DATA_POS_AICOLOR_START = 312,
    VPP_DATA_PQMODULE_DEMO_STATE_START = 313,
    SSM_DATA_MAX,
};
