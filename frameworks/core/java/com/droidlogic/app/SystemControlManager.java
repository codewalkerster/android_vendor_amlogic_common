...
public class SystemControlManager {
    ...
    */
    ...
    public enum PqFuncCase {
        ...
        PQ_CASE_FUNC_BACKLIGHT(1),
        PQ_CASE_FUNC_CONTRAST(2),
        PQ_CASE_FUNC_BRIGHTNESS(3),
        PQ_CASE_FUNC_SATURATION(4),
        PQ_CASE_FUNC_HUE(5),
        PQ_CASE_FUNC_SHARPNESS(6),
        PQ_CASE_FUNC_ASPECT_RATIO(7),
        PQ_CASE_FUNC_AI_PQ(8),
        PQ_CASE_FUNC_AI_COLOR(9),
        PQ_CASE_FUNC_AI_SR(10),
        PQ_CASE_FUNC_GAMMA(11),
        PQ_CASE_FUNC_MANUAL_GAMMA(12),
        PQ_CASE_FUNC_COLOR_TEMP(13),
        PQ_CASE_FUNC_COLOR_MANAGEMENT(14),
        PQ_CASE_FUNC_COLOR_CUSTOMIZE(15),
        PQ_CASE_FUNC_COLOR_RANGE_MODE(16),
        PQ_CASE_FUNC_COLOR_SPACE(17),
        PQ_CASE_FUNC_GLOBAL_DIMMING(18),
        PQ_CASE_FUNC_LOCAL_DIMMING(19),
        PQ_CASE_FUNC_BLACK_STRETCH(20),
        PQ_CASE_FUNC_DNLP(21),
        PQ_CASE_FUNC_LOCAL_CONTRAST(22),
        PQ_CASE_FUNC_SR(23),
        PQ_CASE_FUNC_DNR(24),
        PQ_CASE_FUNC_DEBLOCK(25),
        PQ_CASE_FUNC_DEMOSQUITO(26),
