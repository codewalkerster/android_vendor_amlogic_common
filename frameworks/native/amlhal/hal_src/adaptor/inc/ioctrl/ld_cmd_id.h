...
#define AML_LDIM_IOC_NR_GET_PQ_INIT                     _IO(LD_IOC_MAGIC, IOC_LD_CMD_GET_PQ_INIT)
#define AML_LDIM_IOC_NR_SET_PQ_INIT                     _IO(LD_IOC_MAGIC, IOC_LD_CMD_SET_PQ_INIT)
...
#define AML_LDIM_IOC_NR_GET_BL_MAPPING_PATH             _IOR(LD_IOC_MAGIC, IOC_LD_CMD_GET_BL_MAPPING_PATH, int)
#define AML_LDIM_IOC_NR_SET_BL_MAPPING                  _IOW(LD_IOC_MAGIC, IOC_LD_CMD_SET_MAPPING, int)
#define AML_LDIM_IOC_NR_GET_BL_PROFILE_PATH             _IOR(LD_IOC_MAGIC, IOC_LD_CMD_GET_BL_PROFILE_PATH, int)
#define AML_LDIM_IOC_NR_SET_BL_PROFILE                  _IOW(LD_IOC_MAGIC, IOC_LD_CMD_SET_BL_PROFILE, int)
