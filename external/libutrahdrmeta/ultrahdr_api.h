 ...
 *
 * \param[in]  enc  encoder instance.
 * \param[in]  img  gain map image descriptor.
...
/*!\brief Set gain map scaling factor. The encoding process allows signaling a downscaled gainmap
 ...
 * NOTE: This has no effect on base image rendition. Base image is signaled in full resolution
 * always.
 *
 * \param[in]  enc  encoder instance.
 ...
 * \param[in]  enable  enable enable/disable gpu acceleration
 *
