...
static const struct wpa_cli_cmd wpa_cli_commands[] = {
	...
	{ "twt_setup",
	  ...
	  "[dialog=<token>] [exponent=<exponent>] [mantissa=<mantissa>] [min_twt=<Min TWT>] [setup_cmd=<setup-cmd>] [twt=<u64>] [requestor=0|1] [trigger=0|1] [implicit=0|1] [flow_type=0|1] [flow_id=<3-bit-id>] [protection=0|1] [twt_channel=<twt channel id>] [control=<control-u8>] = Send TWT Setup frame"
	},
	{ "twt_teardown",
