...
#define HCI_TRANSPLANT_SUPPORTED(x) \
  (((x)&HCI_AIR_CODING_FORMAT_MASK) == HCI_AIR_CODING_FORMAT_TRANSPLANT)
...
#define HCI_LMP_TRANSPLANT_SUPPORTED(x) \
  ((x)[HCI_FEATURE_TRANSPLANT_OFF] & HCI_FEATURE_TRANSPLANT_MASK)
...
#define HCI_READ_INQUIRY_SCAN_ACTIVITY_SUPPORTED(x)        \
  ((x)[HCI_SUPP_COMMANDS_READ_INQUIRY_SCAN_ACTIVITY_OFF] & \
   HCI_SUPP_COMMANDS_READ_INQUIRY_SCAN_ACTIVITY_MASK)

#define HCI_SUPP_COMMANDS_WRITE_INQUIRY_SCAN_ACTIVITY_MASK 0x08
#define HCI_SUPP_COMMANDS_WRITE_INQUIRY_SCAN_ACTIVITY_OFF 8
#define HCI_WRITE_INQUIRY_SCAN_ACTIVITY_SUPPORTED(x)        \
  ((x)[HCI_SUPP_COMMANDS_WRITE_INQUIRY_SCAN_ACTIVITY_OFF] & \
   HCI_SUPP_COMMANDS_WRITE_INQUIRY_SCAN_ACTIVITY_MASK)
